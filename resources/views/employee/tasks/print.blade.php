{{-- resources/views/employee/tasks/print.blade.php --}}
<!DOCTYPE html>
<html lang="ar" dir="rtl">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>طباعة مهامي اليومية</title>
...
.print-button {
  ...
  border: none;
  font-size: 0.875rem; /* text-sm approximation */
}
  ...
  <button onclick="window.print()" class="print-button">
    ...
    <div class="print-avoid-break mb-8">
        ...
        <div class="flex items-center justify-between mb-6 border-b-2 border-gray-300 pb-4">
            <div class="flex-1 text-center">
                <h1 class="text-3xl font-bold text-gray-800 mb-2">قائمة مهامي اليومية</h1>
        ...
        <div class="bg-gray-50 border border-gray-300 rounded-lg p-4 mb-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                ...
                <div>
                    <span class="font-semibold text-gray-700">تاريخ المهمة:</span>
                ...
                <div class="col-span-2">
                    <span class="font-semibold text-gray-700">عدد النتائج:</span>
                ...
                @forelse($tasks as $task)
                    <tr class="{{ $loop->even ? 'bg-gray-50' : 'bg-white' }}">
                        ...
                        <td class="text-center border border-gray-300 py-2 px-2">
                            <div class="font-medium">{{ $task->task_date }}</div>
                        </td>
                    ...
                    <tr>
                        <td colspan="6" class="text-center py-8 border border-gray-300">
                            <div class="text-gray-500">
                                ...
                                <div class="text-sm">لا توجد مهام مطابقة للفلاتر الحالية</div>
                            </div>
                        </td>
                    </tr>
                @endforelse
    ...
    <div class="mt-8 pt-4 border-t border-gray-300 print-avoid-break">
        <div class="grid grid-cols-2 gap-4 text-xs text-gray-600">
            ...
            <div class="text-left">
                <div><strong>الموظف:</strong> {{ auth('employee')->user()->name ?? 'غير محدد' }}</div>
