            ...
            <div class="flex items-center space-x-5 space-x-reverse">
                <div class="flex-shrink-0">
                    <div class="h-20 w-20 rounded-full bg-red-600 flex items-center justify-center">
                        <i class="fas fa-camera text-gray-100 text-3xl"></i>
                    </div>
                </div>
                ...
                <div class="flex space-x-3 space-x-reverse">
                    @if($photographyCost->created_by_type == 'employee' && $photographyCost->created_by == auth('employee')->id())
                    <a href="{{ route('employee.photography-costs.edit', $photographyCost) }}" 
