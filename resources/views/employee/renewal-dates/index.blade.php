{{-- resources/views/employee/renewal-dates/index.blade.php --}}
...
<div class="container-fluid p-6">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-4">
                ...
                <div class="max-h-48 overflow-y-auto space-y-2">
                    ...
                    <div class="bg-white rounded-lg p-3 border border-blue-100 ">
                        ...
                        @endif
                        <div class="mt-2">
                            <a href="{{ route('employee.renewal-dates.show', $renewal) }}" 
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
        ...
        <div class="p-6">
            <form method="GET" action="{{ route('employee.renewal-dates.index') }}">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <select name="frequency" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors">
                        ...
                        @endif">
                            ...
                            <td class="px-3 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center gap-1">
                                    ...
                                    <a href="{{ route('employee.renewal-dates.edit', $renewal) }}" 
                                    ...
                                    <form id="delete-form-{{ $renewal->id }}" 
                                          action="{{ route('employee.renewal-dates.destroy', $renewal) }}" 
                                          method="POST" 
                                          style="display: none;">
                                        @csrf
                                        @method('DELETE')
