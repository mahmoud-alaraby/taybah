{{-- resources/views/employee/print-booking/index.blade.php --}}
...
<div class="container-fluid p-6">
    ...
    <div class="mb-6">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('employee.print-booking.create') }}" 
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
        ...
        <div class="p-6">
            <form method="GET" action="{{ route('employee.print-booking.index') }}">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-2 py-2 whitespace-nowrap text-xs font-medium">
                                    <div class="flex items-center gap-1">
                                        <a href="{{ route('employee.print-booking.show', $booking) }}" 
                                        ...
                                        @if($booking->created_by_employee == $employeeId || $booking->assigned_person_id == $employeeId)
                                            <a href="{{ route('employee.print-booking.edit', $booking) }}" 
                                                class="text-yellow-600 hover:text-yellow-900 transition-colors p-1 rounded" title="تعديل">
                                                <i class="fas fa-edit text-xs"></i>
                                            </a>
                                        @endif
                                        @if($booking->created_by_employee == $employeeId)
                                            <form action="{{ route('employee.print-booking.destroy', $booking) }}" 
