                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($customers as $customer)
                            ...
                            <tr class="hover:bg-gray-50 transition-colors {{ $isDifficult ? 'bg-red-25 border-r-4 border-red-400' : '' }}">
                                <!-- العميل -->
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($chat && $chat->employee)
                                        <div class="flex items-center">
                                            ...
                                            <div class="mr-2">
                                                <div class="text-sm font-medium text-gray-900">{{ $chat->employee->name }}</div>
                                            </div>
                                        </div>
                                    @else
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($chat)
                                        ...
                                        <div class="flex flex-col space-y-1">
                                            ...
                                            @if($unreadCount > 0)
                                                <div class="flex items-center">
                                                    <span class="inline-flex items-center justify-center w-5 h-5 bg-red-500 text-white rounded-full text-xs font-medium animate-pulse">
                                                        {{ $unreadCount }}
                                                    </span>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    @if($chat && $chat->last_message_at)
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-xs text-gray-400">{{ $chat->last_message_at->format('Y/m/d H:i') }}</span>
                                        </div>
                                    @else
