                        ...
                        <a href="{{ route('admin.customer-communication.show', $customer->id) }}" 
                           class="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-medium py-3 px-4 rounded-lg transition-all duration-300 flex items-center justify-center group-hover:shadow-lg">
                            ...
                            @else
                                ...
                                متابعة الشات مع {{ $chat->employee->name }}
                            @endif
                        </a>
                    @else
                        <div class="w-full bg-gray-200 text-gray-500 font-medium py-3 px-4 rounded-lg text-center">
                            <i class="fas fa-info-circle ml-2"></i>
                            في انتظار بدء التواصل من الموظف
                        </div>
                    @endif
                </div>
            </div>
...
setInterval(function() {
    if (document.visibilityState === 'visible') {
        fetch('/admin/customer-communication/unread-count')
