...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow rounded-lg">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-8">
            <div class="bg-gradient-to-r from-red-600 to-red-700 px-6 py-5 rounded-t-xl">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-4 sm:space-y-0">
                    <div class="flex items-center">
                        ...
                        <div class="mr-4">
                            <h1 class="text-xl sm:text-2xl font-bold text-white">إضافة رد جديد للقاموس </h1>
                            <p class="text-blue-100 text-sm mt-1">أضف رد جديد  إلى نظام قاموس الرد على العملاء </p>
                        </div>
                    </div>
            ...
            <form class = "" action="{{ route('admin.customer-response.store') }}" method="POST">
                @csrf
                <div class="space-y-6 px-4 py-6 sm:p-8">
                    <div>
                        <label class="font-medium text-gray-700 flex items-center mb-1">
                            <svg ... class="w-5 h-5 text-indigo-400 ml-1"></svg>
                            التصنيف
                        </label>
                ...
                <div class="flex justify-end gap-4 mt-10 ">
                    <a href="{{ route('admin.customer-response.index') }}" class="bg-gray-100 text-gray-700 px-4 py-2 rounded-md border">إلغاء</a>
                    <button type="submit"
