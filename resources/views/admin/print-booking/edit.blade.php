{{-- resources/views/admin/print-booking/edit.blade.php --}}
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="bg-gradient-to-r from-red-600 to-red-700 px-6 py-4">
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-4 sm:space-y-0">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <a href="{{ route('admin.print-booking.show', $printBooking) }}" 
        ...
        <form action="{{ route('admin.print-booking.update', $printBooking) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
                        ...
                        <select name="assigned_person_id"
                            ...
                            @if(isset($employees))
                                @foreach($employees as $employee)
                                    <option value="{{ $employee->id }}" {{ old('assigned_person_id', $printBooking->assigned_person_id) == $employee->id ? 'selected' : '' }}>
