...
<div class="min-h-screen bg-gray-50 py-8">
            ...
            <div class="space-y-8">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            <label class="block text-sm font-semibold text-gray-700 flex items-center">
                                <svg class="w-4 h-4 text-indigo-600 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="space-y-2">
                            <label class="block text-sm font-semibold text-gray-700 flex items-center">
                                <svg class="w-4 h-4 text-green-600 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h1l3 8 4-16 3 8h1"></path>
                                </svg>
                                رقم الجوال
                            </label>
    ...
    {{-- وصف العمل --}}
                        <div class="space-y-2">
                            <label class="block text-sm font-semibold mt-6 text-gray-700 flex items-center">
                                <svg class="w-4 h-4 text-yellow-600 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21H5a2 2 0 01-2-2V7a2 2 0 012-2h11l5 5v9a2 2 0 01-2 2z"></path>
                                </svg>
                                وصف العمل المطلوب
                            </label>
                            <textarea name="work_description" rows="4" 
                                      class="w-full mb-6 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors @error('work_description') border-red-600 ring-2 ring-red-200 @enderror" 
                    ...
                    <div class="mt-6">
                        <label class="block text-sm font-semibold text-gray-700 mb-1 flex items-center">
                            <svg class="w-4 h-4 text-blue-600 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m3-2h-4v6h4m5-14h-12a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2v-16a2 2 0 00-2-2z"></path>
                            </svg>
                            ملاحظات إضافية
                        </label>
                    ...
                    @if(isset($potentialCustomer) && $potentialCustomer->whatsapp_link)
                        <div class="bg-green-50 mt-4 p-4 rounded-lg">
                            <h5 class="text-sm font-medium text-green-700 mb-2">رابط التواصل المباشر</h5>
                ...
                <div>
                    ...
                    <label class="block text-sm font-medium text-gray-700 mb-3 flex items-center space-x-2 space-x-reverse">
                        <svg class="w-4 h-4 text-gray-600 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                        اختر التصنيفات المناسبة للعميل:
                    </label>
                            ...
                            <label class="flex items-start">
                                ...
                                <div class="mr-3 flex-1">
                                    <div class="flex items-center space-x-2 space-x-reverse">
                                        <span class="text-sm font-semibold text-gray-900">{{ $classification['display_name'] }}</span>
