<!-- resources/views/admin/receipts-payments/print.blade.php -->
<!DOCTYPE html>
<html lang="ar" dir="rtl">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>تقرير المقبوضات والمدفوعات - {{ $months[$month] }} {{ $year }}</title>
...
<body>
    <div class="header">
        <h1>شركة طيبة</h1>
        <h2>تقرير المقبوضات والمدفوعات</h2>
                ...
                <tbody>
                    @foreach($receipts as $receipt)
                        <tr>
                            ...
                            <td>{{ $receipt->employee->name }} ({{ $receipt->employee->employee_id }})</td>
                ...
                <tbody>
                    @foreach($payments as $payment)
                        <tr>
                            ...
                            <td>{{ $payment->employee->name }} ({{ $payment->employee->employee_id }})</td>
    ...
    <div class="footer">
        ...
        <p>نظام إدارة شركة طيبة - تقرير إداري</p>
    </div>
