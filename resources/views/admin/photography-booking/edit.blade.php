{{-- resources/views/admin/photography-booking/edit.blade.php --}}
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
            ...
            <p class="text-slate-600 mt-1 text-lg">تعديل بيانات الحجز</p>
        </div>
        <div class="flex flex-col sm:flex-row gap-3">
            <a href="{{ route('admin.photography-booking.show', $photographyBooking) }}" 
               class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-lg shadow-sm transition-all duration-200">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <form action="{{ route('admin.photography-booking.update', $photographyBooking) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
                        ...
                        <select name="assigned_person_id"
                            ...
                            @if(isset($employees))
                                @foreach($employees as $employee)
                                    <option value="{{ $employee->id }}" {{ old('assigned_person_id', $photographyBooking->assigned_person_id) == $employee->id ? 'selected' : '' }}>
