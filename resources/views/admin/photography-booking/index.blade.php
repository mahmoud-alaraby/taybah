{{-- resources/views/admin/photography-booking/index.blade.php --}}
...
<div class="container-fluid p-6">
 ...
 <!-- Statistics Cards - التصميم المحدث -->
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="bg-gradient-to-r from-red-50 to-orange-50 border border-red-200 rounded-xl p-4 mb-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h4 class="text-red-800 font-semibold">لديك {{ $unreadBookingCount }} إشعار جديد</h4>
                            <p class="text-red-600 text-sm">انقر لعرض جميع الإشعارات</p>
                        </div>
                    </div>
                    <a href="{{ route('admin.photography-booking.notifications') }}" 
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
        ...
        <div class="p-6">
            <form method="GET" action="{{ route('admin.photography-booking.index') }}">
